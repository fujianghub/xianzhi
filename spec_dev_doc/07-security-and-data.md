...
> 状态：已采纳 · 版本：v3 · 更新：2026-09-24 · 最后对照代码：2026-09-24（登录拼图威胁行） · 依据 ADR-0001 §4.6 §9.4、01 §1 §3.8 §3.12 §4、02 §2 §7 §9、05 §8。多用户邀请制下的威胁模型、数据保留、账号生命周期、限额。散在各规范的安全与保留规则以本文集中表为准；本文与其他规范冲突时，先改本文再改代码。需求编号见 `00-requirements.md` 的 REQ-AUTH-* / REQ-WS-* / REQ-ATTACH-* / REQ-OPS-*。
