...
> 状态：已采纳 · 版本：v3 · 更新：2026-09-24 · 最后对照代码：2026-09-24（ADR-0005 / 0006：动效档位、组件清单） · 依据 ADR-0001 §9.3、ADR-0002。组件只消费本文定义的 token；新增视觉决定先改本文再改代码。品牌视觉细节（插画、Logo）在进入 UI 阶段时用设计画布定稿后回填 §2。
